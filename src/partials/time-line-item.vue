...
export default class TimeLineItemComponent extends Vue {
    ...
    get dayOfWeek() {
        return "周" + "日一二三四五六".charAt( new Date(this.item.createTime).getDay());
    }
